...
const App = () => {
    ...
    const [tasks, setTasks] = useState([ // ф-ция  useStateвозвращает массив 2-х элементов, массив данных и ф-цию которая изменяет массив
    ...
    const changeFilter = (newFilteredValue: FilterValueType) => setSilter(newFilteredValue)
    ...
    const getFiltredTasks = (allTasks: TaskType[], newFilteredValue: FilterValueType): TaskType[] => {
